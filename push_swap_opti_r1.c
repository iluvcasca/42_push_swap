...
/*   Updated: 2024/04/01 15:17:06 by kgriset          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "push_swap.h"

void	count_ops_r(t_circular_db_ll *cdl_list, t_double_link_node **node,
...
void	iter_ops_ra(t_circular_db_ll *cdl_list, t_double_link_node **cdl_node_r,
		size_t *count_r, t_double_link_node **cdl_node)
{
...
void	iter_ops_rb(t_circular_db_ll *cdl_list, t_double_link_node **cdl_node_r,
		size_t *count_r, t_double_link_node **cdl_node)
{
...
void	del_r(t_circular_db_ll *cdl_list, t_double_link_node **cdl_node_r,
		size_t *count_r, size_t *count_rr)
{
