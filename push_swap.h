...
/*   Updated: 2024/04/05 09:20:30 by kgriset          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						parse_input(int argc, char **argv,
							t_circular_db_ll *cdl_list);
int						parse_string(char *string, t_circular_db_ll *cdl_list,
							int *status);
int						parse_arguments(int argc, char **argv,
							t_circular_db_ll *cdl_list, int *status);
int						add_int2node(t_circular_db_ll *cdl_list,
							t_double_link_node *cdl_node, int value);
int						*cdl2array(t_circular_db_ll *cdl_list);
int						check_duplicate(t_circular_db_ll *cdl_list);

// operations
int						swap(t_circular_db_ll *cdl_list, char list_name,
							t_circular_db_ll *ops);
int						ss(t_circular_db_ll *cdll_a, t_circular_db_ll *cdll_b,
							t_circular_db_ll *ops);
int						push(t_circular_db_ll *cdll_a, t_circular_db_ll *cdll_b,
							char list_name, t_circular_db_ll *ops);
int						rotate(t_circular_db_ll *cdl_list, char list_name,
							t_circular_db_ll *ops);
int						rr(t_circular_db_ll *cdll_a, t_circular_db_ll *cdll_b,
							t_circular_db_ll *ops);
int						r_rotate(t_circular_db_ll *cdl_list, char list_name,
							t_circular_db_ll *ops);
int						r_rr(t_circular_db_ll *cdll_a, t_circular_db_ll *cdll_b,
							t_circular_db_ll *ops);

void					push_n(t_vars *vars, char list_name, size_t n);
void					r_rotate_n(t_circular_db_ll *cdl_list, char list_name,
							size_t n, t_circular_db_ll *ops);
void					rotate_n(t_circular_db_ll *cdl_list, char list_name,
							size_t n, t_circular_db_ll *ops);
...
void					update_merge(size_t *width, int **array,
							int **array_cpy);
...
void					reorder(t_circular_db_ll *cdll_a,
							t_circular_db_ll *rank_a, t_circular_db_ll *ops);
int						abs(int a);

void					count_ops_r(t_circular_db_ll *cdl_list,
							t_double_link_node **node, size_t *count, char ops);
void					insert_rr(t_circular_db_ll *cdl_list,
							t_double_link_node *node);
int						optimize_ops_r(t_circular_db_ll *cdl_list);
void					process_ops_r(t_circular_db_ll *cdl_list,
							t_double_link_node **cdl_node_r, size_t *count_r,
							t_double_link_node **cdl_node);
void					insert_while_rr(t_circular_db_ll *cdl_list,
							t_double_link_node *cdl_node, size_t *count_rr);
void					del_r(t_circular_db_ll *cdl_list,
							t_double_link_node **cdl_node_r, size_t *count_r,
							size_t *count_rr);
void					iter_ops_rb(t_circular_db_ll *cdl_list,
							t_double_link_node **cdl_node_r, size_t *count_r,
							t_double_link_node **cdl_node);
void					iter_ops_ra(t_circular_db_ll *cdl_list,
							t_double_link_node **cdl_node_r, size_t *count_r,
							t_double_link_node **cdl_node);

void					count_ops_rr(t_circular_db_ll *cdl_list,
							t_double_link_node **node, size_t *count, char ops);
void					insert_rrr(t_circular_db_ll *cdl_list,
							t_double_link_node *node);
